...
export const ui = {
  ...
  boardColumn:
    "flex w-72 shrink-0 flex-col rounded-xl border border-slate-200 bg-slate-50",
  boardColumnOver: "border-slate-400 bg-slate-100",
  boardCard:
    "block w-full rounded-lg border border-slate-200 bg-white p-3 text-left shadow-sm hover:border-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400",
